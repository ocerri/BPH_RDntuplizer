...
if args.inputFile:
    ...
    fdefault += 'inputFiles_BP_Tag-Probe_Bp_JpsiK_Hardbbbar_evtgen_SVS_PUc0_10-2-3.txt'
...
process.B2JpsiKstDT = cms.EDProducer("B2JpsiKDecayTreeProducer",
...
process.MCpart = cms.EDProducer("MCTruthB2JpsiKProducer",
