...
if args.outputFile == '.root':
    outname = 'B2DstpHadm_CAND.root'
elif args.outputFile.startswith('_numEvent'):
    outname = 'B2DstpHadm_CAND' + args.outputFile
else:
...
process.trgF = cms.EDFilter("TriggerObjectsFilter",
        object_charge = cms.int32(0),
        verbose = cms.int32(0)
)


process.B2MuDstDT = cms.EDProducer("B2HadDstDecayTreeProducer",
        trgCandidates = cms.InputTag("trgF","trgCandidatesMatched", ""),
        charge_trgCand = cms.int32(-1),
