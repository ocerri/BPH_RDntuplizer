...
if args.outputFile == '.root':
    outname = 'TagAndProbe_Bp2DmstPipPip_CAND.root'
elif args.outputFile.startswith('_numEvent'):
    outname = 'TagAndProbe_Bp2DmstPipPip_CAND' + args.outputFile
else:
...
process.B2MuDstDT = cms.EDProducer("TagAndProbeBp2DmstPipPipProducer",
        trgMuons = cms.InputTag("trgF","trgMuonsMatched", ""),
        charge_K = cms.int32(+1),
        charge_pi = cms.int32(-1),
        charge_pi1 = cms.int32(+1),
        charge_pi2 = cms.int32(+1),
