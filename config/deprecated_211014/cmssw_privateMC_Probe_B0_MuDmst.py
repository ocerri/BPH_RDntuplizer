...
if args.inputFile:
    ...
    fdefault += 'inputFiles_BP_Probe_B0_MuNuDmst_Tag-B_MuNuDst_Hardbbbar_evtgen_ISGW2_PUc0_10-2-3.txt'
...
if args.outputFile == '.root':
    outname = 'probeB2DstMu_CAND.root'
elif args.outputFile.startswith('_numEvent'):
    outname = 'probeB2DstMu_CAND' + args.outputFile
else:
...
process.B2MuDstDT = cms.EDProducer("probeB2DstMu_tagMuProducer",
