...
if args.inputFile:
    ...
    with open(fdefault) as f:
        flist = [l[:-1] for l in f.readlines()]
    flist = flist[:10]
    # flist = ['/store/data/Run2018D/ParkingBPH1/MINIAOD/05May2019promptD-v1/270000/0639BC54-D852-F24C-BA2C-41A95B5C3EC5.root']
    flist = ['file:0639BC54-D852-F24C-BA2C-41A95B5C3EC5.root']
...
if args.outputFile == '.root':
    outname = 'TagAndProbe_Bp2DmstPim3Pip_CAND.root'
elif args.outputFile.startswith('_numEvent'):
    outname = 'TagAndProbe_Bp2DmstPim3Pip_CAND' + args.outputFile
else:
...
process.B2MuDstDT = cms.EDProducer("TagAndProbeBp2DmstPipPipPipPimProducer",
