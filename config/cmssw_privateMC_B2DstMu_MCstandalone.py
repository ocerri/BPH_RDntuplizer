...
if args.outputFile == '.root':
    outname = 'MCB2DstMu_CAND.root'
elif args.outputFile.startswith('_numEvent'):
    outname = 'MCB2DstMu_CAND' + args.outputFile
else:
...
#################   Sequence    ####################
'''
inputGenParticles = cms.InputTag("genParticles","", "SIM")
if 'MINIAODSIM' in flist[0]:
    inputGenParticles = cms.InputTag("prunedGenParticles","", "PAT")

process.MCpart = cms.EDProducer("MCTruthB2DstMuProducer_standalone",
        genParticlesCollection = inputGenParticles,
        verbose = cms.int32(1)
)
