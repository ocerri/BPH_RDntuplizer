...
ntuplesName=ntuples_B2DstMu_test
...
for process in "${processes[@]}"; do
    ...
    mkdir -p $output_dir
    python jobSubmission/create-condor-jobs -i production/inputFiles_$process.txt -o $output_dir/out_CAND.root -c $config -t $ntuplesName -N 5 --maxtime 120m
    sleep 1
done
